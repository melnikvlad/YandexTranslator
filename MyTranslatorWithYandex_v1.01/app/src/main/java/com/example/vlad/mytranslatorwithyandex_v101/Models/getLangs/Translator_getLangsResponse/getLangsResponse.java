package com.example.vlad.mytranslatorwithyandex_v101.Models.getLangs.Translator_getLangsResponse;
...
public class getLangsResponse {
    ...
    public List<String> getResponseDirs(getLangsResponse response){
        List<String> dirs_list = new ArrayList<>();
        dirs_list = response.getDirs();
        return dirs_list;
    }

    public List<String> getResponseKeys(getLangsResponse response){
    ...
    public List<String> getResponseValues(getLangsResponse response){
